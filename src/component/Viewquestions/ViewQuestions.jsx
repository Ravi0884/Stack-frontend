...
function ViewQuestions() {
  ...
  useEffect(() => {
    axios.get(`https://stackbackend-y1d5.onrender.com/api/question/${id}`)
      .then(response => {
...
useEffect(() => {
    axios.put(`https://stackbackend-y1d5.onrender.com/api/question/questionViews/${id}`)
      .then(response => {
  ...
  useEffect(() => {
    axios.get(`https://stackbackend-y1d5.onrender.com/api/answer/${id}`)
      .then(response => {
  ...
  const handleSubmit = async(event) => {
    axios.put(`https://stackbackend-y1d5.onrender.com/api/question/answerViews/${id}`)
    .then(response => {
    ...
    await axios.post("https://stackbackend-y1d5.onrender.com/api/answer",parsedData).then((res)=>{
        setloading(false);
