...
function Main(props) {
  ...
  return (
    ...
    <div className="main">
        ...
        {/* <AllQuestions /> */}
        {questions && questions.map((question) =><AllQuestions key={question._id} tags={question.tags} title={question.title} user={question.user} createdAt={question.createdAt} _id={question._id} views={question.views} answers={question.answers}/>)}
        </div>
    </>
  )
}
